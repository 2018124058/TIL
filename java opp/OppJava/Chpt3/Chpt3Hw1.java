	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if (command.equals("area")) {
				...
				x1 = Integer.valueOf(command.substring(3));
				...
				x2 = Integer.valueOf(command.substring(3));
				...
				y1 = Integer.valueOf(command.substring(3));
				...
				y2 = Integer.valueOf(command.substring(3));
